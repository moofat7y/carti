    ...
    return (
        <div className="report w-full p-4">
            ...
            <div className="boxes flex flex-wrap gap-5 justify-between py-6">
                ...
                {/* BOX */}
                <div className="box flex gap-3 items-center mb-5">
                    <Button onClick={handleOpen} className="bg-transparent shadow-none hover:shadow-none flex gap-3 items-center mb-5 p-0 rounded-none m-0">
                    ...
                    <Dialog open={open} handler={handleOpen} className="overflow-hidden">
                        <DialogHeader className="bg-purple-100 text-xl">حدد الهدف الذي تطمح لتحقيقه في المبيعات</DialogHeader>
                        <DialogBody>
                            <input type="number" name="goal-number" id="goal-number" placeholder="12000" className="outline-none border rounded-md w-full p-1 text-xl font-normal" />
                        </DialogBody>
